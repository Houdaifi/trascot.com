<template>
  <div class="flex flex-col xl:flex-row justify-between bg-gray-800 text-gray-200 text-base leading-loose tracking-wider">
    <div class="flex flex-col justify-center text-left py-28 pl-4 2xl:pl-16">
